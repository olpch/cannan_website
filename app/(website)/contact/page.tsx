  ...
  return (
    <>
        ...
        <div  className="flex flex-row flex-wrap items-center justify-center">
            <div className="bg-transparent min-w-3xl mx-10 sm:min-w-3sm xs:min-3xs">
            ...
            <div className="flex flex-col items-center justify-center min-w-lg mx-10 sm:min-w-3xs md:items-start text-center md:text-left">
                <Image
